  ...
  return (
    <div className="space-y-12">
      ...
      <GradientHeader
        ...
        subtitle="Feedback Fusion is where your ideas come to life. Suggeest features, vote on what matters most, and follow our public roadmap."
        >
      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">
                Share your suggestions and ideas for new features or improvements. Your feedback helps us prioritize what to build next.
              </p>
            </CardContent>
          </Card>
          <Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">
                Watch as your feedback transforms into real features and improvements.
              </p>
            </CardContent>
          </Card>
        </div>
